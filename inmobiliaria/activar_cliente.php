...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    // Prepara la consulta SQL para actualizar el estado del cliente a 'activo'
    $sql = "UPDATE clientes SET estado = 'activo' WHERE ClienteID = '$cliente_id'";
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        $_SESSION['mensaje'] = "Error al activar el cliente: " . mysqli_error($conn);
    }
} else {
...
header("location: clientes.php?mostrar=inactivos"); // Redirige a la vista de inactivos para ver el cambio
exit;
